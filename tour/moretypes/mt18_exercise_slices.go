...
// Implement Pic. It should return a slice
// of length dy, each element of which is
// a slice of dx 8-bit unsigned integers.
// When you run the program, it will display
// your picture, interpreting the integers
// as grayscale (well, bluescale) values.
//
...
// []uint8 inside the [][]uint8.)
//
// (Use uint8(intValue) to convert between
// types.)
func ExSlices() {
