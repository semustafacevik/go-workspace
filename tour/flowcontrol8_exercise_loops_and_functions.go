...
// until we reach an answer that is as close to the actual
// square root as can be.
//
// Implement this in the func Sqrt provided. A decent starting guess
// for z is 1, no matter what the input. To begin with, repeat
// the calculation 10 times and print each z along the way.
...
// the z² − x above is how far away z² is from where it needs
// to be (x), and the division by 2z is the derivative of z², to scale
// how much we adjust z by how quickly z² is changing. This general
// approach is called Newton's method. It works well for many functions
// but especially well for square root.)
func ExLoopsAndFunctions() {
